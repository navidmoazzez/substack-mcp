...
#
#   bash desktop-extension/build.sh    ->  desktop-extension/substack-<version>.mcpb
set -euo pipefail
...
npx -y @anthropic-ai/mcpb@latest pack "$build" "$root/desktop-extension/substack-$version.mcpb"

echo
echo "Built desktop-extension/substack-$version.mcpb"
